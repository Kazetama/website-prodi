                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">
                                Buat pengumuman baru untuk sistem.
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="rounded-xl border bg-card text-card-foreground shadow-sm p-6 space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Informasi utama pengumuman yang akan ditampilkan kepada pengguna.
                                    </p>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        placeholder="Contoh: Jadwal Libur Akademik"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <Textarea
                                            ...
                                            placeholder="Tulis detail pengumuman lengkap di sini..."
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="rounded-xl border bg-card text-card-foreground shadow-sm p-5 space-y-5">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">Opsional, jika ada acara.</p>
                                </div>
                                <hr className="border-border/50" />
